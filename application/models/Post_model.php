...
class Post_model extends CI_Model
{
	...
	/*
	 * smileshare_post is used to display post according pagination
	...
	/*
	 * challange_post is used to display post according pagination
	 * @param $data 	array[]	specify where condition
	 * @param $logged_in_user int user_id of logged in user
	 * @param $start 	int 	specify start position for pagination
	 * @param $limit 	int 	specify page size
...
/*
		...
		foreach ($post as $row) {
			$post['post_media'] = '';
			if(in_array($row['id'], $post_media_ids))
			{
