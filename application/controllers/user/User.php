        ...
        if (!empty($_FILES['image-0']['name'])) {
            ...
            for ($i = 0; $i < $filecount; ++$i) {
                ...
                if (!$this->upload->do_upload('video-0')) {
                    ...
                    $cmd = ROOT_PATH . "ffmpeg -i " . ROOT_PATH . "uploads/chat_media/" . $data['file_name'] . " -ss 00:00:01.435 -f image2 -vframes 1 " . ROOT_PATH . "uploads/chat_media/" . $data['raw_name'] . "_thumb.png";
