...
<!--                            <p class="notifctn"><b>Mike</b> Changed topic.</p> -->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="topich_chat_typesec_slmt topich_chat_typesec_grp">
                    ...
                    <!-- what's today section start here -->
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="topich_chat_typesec_slmt">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="">
                                        <p class="tody_hdg">What's Today <span class="pull-right">Date</span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="topic_prfle_icon_sec">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <ul class="list-inline whats_ul">
                                                ...
                                                <li><a href="#" class="show_chat">Review</a></li>
                                            </ul>
                                        </div>
...
<script type="text/javascript" src="<?php echo USER_JS ?>/groupplan/join_groupplan.js"></script>
<!-- Lazy loading -->
<script>
    $('document').ready(function () {
        ...
        {
            $.ajax({
                url: base_url + 'groupplan/load_more_msg/' + group_id,
                method: 'post',
                async: false,
