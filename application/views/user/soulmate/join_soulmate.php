    ...
    <div class="container topic_2cntnr">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 soulmate2_hdgsec">
                        <div class="row">
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                <p class="due_para">Upload files</p>
                            </div>
        ...
        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 soulmate_2right_sec">
            <div class="soulmate_2right_secinr">
                ...
                <div class="row hide_xs">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="">
                            <p class="tody_hdg">What's Today</p>
                        </div>
                    </div>
                </div>

                <div class="row tody_pln_row hide_xs">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="wts_tdy1">
                            <p class="grpl_plntxt text-lft">Plan</p>
                            <p class="descriptn grp_dercp">
                                Lorem Ipsum is simply dummy text Lorem Ipsum is simply dummy text 
                            </p>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="wts_tdy_col2">
                            <div class="row wts_tdy2">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pad_rit0">
                                    <div class="slf_prfl">
                                        <ul class="list-inline slf_prfl_check_ul">
                                            <li><img src="<?php echo DEFAULT_IMAGE_PATH; ?>/pst_prfl_icon.png" class="img-responsive"></li>
                                            <li><img src="<?php echo DEFAULT_IMAGE_PATH; ?>/grn_check.png" class="img-responsive"></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                ...
                <div class="row usr_row hide_xs">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="slmt_grp">
                            <p class="usr_p usr_p2"><?php echo $soulmate['name'] ?></p>
                            <p class="usr_p usr_p2">Slogan : <?php echo $soulmate['slogan']; ?></p>
                ...
                <div class="row chat_msg_sec">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mble_pd_0">
                        <div class="chat_area_solmat chat_area2">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="topich_chat_typesec_slmt">
