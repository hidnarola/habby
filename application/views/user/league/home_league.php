        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 prsnl_sm_innrsec">
            <div class="prfl_cvr_sec">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 topi_prsnl">
                    <h2 class="leag-res">My league and alliance</h2>
                </div>
                <div class="row">
                    <?php
...
//                            pr($my_league);
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 topi_prsnl">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 league_prsnl">
                                    ...
                                    <p class="enter_btn"><a href="<?php echo base_url() . "league/details/" . urlencode(base64_encode($my_league['id'])) ?>">Enter the League</a></p>
                                </div>
                            </div>
                            <hr/>
                            <?php
                ...
                <hr/>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 topi_prsnl">
                    <h2 class="leag-res">Applied league and alliance</h2>
                        ...
                        foreach ($joined_leagues as $joined_league) {
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 topi_prsnl">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 league_prsnl">
                                    ...
                                    <p>Role in League : User </p>
                                    <p><?php echo date('d/m/y', strtotime($joined_league['created_date'])); ?></p>
                                    <p><?php echo $joined_league['introduction']; ?></p>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 league_prsnl">

                                    <p class="enter_btn"><a href="<?php echo base_url() . "league/details/" . urlencode(base64_encode($joined_league['id'])) ?>">Enter the League</a></p>
                                </div>
                            </div>
                            <hr/>
                            <?php
