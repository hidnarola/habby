                ...
                <div class="panel panel-default top_rate_panel votepnl">
                    ...
                    <div class="panel-body">
                        <div class="row vote_row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-10 col-xs-10 vot3">
                                <a class="fancybox"  href="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img7_7.jpg" data-fancybox-group="gallerytopichat1">
                                    <img src="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img7_7.jpg" class="img-responsive center-block ">
                                </a>									
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="row vote_row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-10 col-xs-10 vot3">
                                <a class="fancybox"  href="<?php echo DEFAULT_IMAGE_PATH; ?>League-Alliance2_img2.jpg" data-fancybox-group="gallerytopichat1">
                ...
                <div class="panel panel-default popular_img_sec">
                    ...
                    <div class="panel-body">
                        <ul class="photo_vdo_ul">
                            ...
                            <li>
                                <a class="fancybox"  href="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img4.jpg" data-fancybox-group="gallery1">
                                    <img src="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img4.jpg" class="img-responsive">
                                </a>
                            </li>
                            <li>
                                <a class="fancybox"  href="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img5.jpg" data-fancybox-group="gallery1">
                                    <img src="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img5.jpg" class="img-responsive">
                                </a>
                            </li>
                            <li>
                                <a class="fancybox"  href="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img6.jpg" data-fancybox-group="gallery1">
                                    <img src="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img6.jpg" class="img-responsive">
                                </a>
                            </li>
                            <li>
                                <a class="fancybox"  href="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img7.jpg" data-fancybox-group="gallery1">
                                    <img src="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img7.jpg" class="img-responsive">
                                </a>
                            </li>
                            <li>
                                <a class="fancybox"  href="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img8.jpg" data-fancybox-group="gallery1">
                                    <img src="<?php echo DEFAULT_IMAGE_PATH; ?>topi_chat_img8.jpg" class="img-responsive">
                                </a>
                            </li>
