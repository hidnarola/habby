<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-file-picture"></i> <span class="text-semibold"><?php echo $heading; ?></span></h4>
        </div>
    </div>
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="<?php echo site_url('admin/home'); ?>"><i class="icon-home2 position-left"></i> Home</a></li>
            <li><a href="<?php echo site_url('admin/banners'); ?>"><i class="icon-file-picture position-left"></i> Banners</a></li>
                ...
                <div class="panel panel-flat">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <?php if (isset($banner_datas) && !empty($banner_datas)) { ?>
                                    <input type="text" name="page" placeholder="Enter page name" class="form-control" value="<?php echo (isset($banner_datas['page'])) ? $banner_datas['page'] : set_value('page'); ?>" disabled="disabled">
                                <?php } else { ?>
