...
<div class="page-header page-header-default">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><i class="icon-magazine position-left"></i> Topichat Groups</li>
        </ul>
    </div>
</div>
<!-- /page header -->
    ...
    <div class="content">
        <div class="panel panel-flat">
            <div class="panel-heading text-right">
                <a href="<?php echo site_url('admin/topichat/add'); ?>" class="btn btn-success btn-labeled"><b><i class="icon-add"></i></b> Add new post</a>
            </div>
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (full.is_blocked == '0') {
                            ...
                            action += '&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/topichat/delete/' + full.id + '" class="btn border-danger text-danger-600 btn-flat btn-icon btn-rounded" title="Delete"><i class="icon-cross2"></i></a>'
                        } else {
