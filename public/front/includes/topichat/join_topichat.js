                    ...
                    $.ajax({
                        ...
                        success: function (str)
                        {
                            if (str != 0)
                            {
                                ...
                                var html = '<li class="topi_image_li"> <a data-toggle="modal" data-target="#postModal" data-image="' + media_file[0].media + '" data-type="image"> <img src="' + upload_path + media_file[0].media + '" class="img-responsive topi_image"> </a> </li>';
    ...
    $.ajax({
        ...
        success: function (str)
        {
            ...
            else if (str != 0)
            {
                ...
                var html = '<li class="topi_image_li"> <a data-toggle="modal" data-target="#postModal" class="video-w-icon" data-image="' + media_file[0].media + '" data-type="video" > <img src="' + upload_path + video_thumb + '" class="img-responsive topi_image"> </a> </li>';
