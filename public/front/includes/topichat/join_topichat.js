        ...
        success: function (preview) {
            if (JSON.stringify(preview) != '{}') {
                if (preview.title == null && preview.description == null) {
                    ...
                    $('#url').val('');
                    $('#url').prop('disabled', false);
                    $(".chat_area2").animate({scrollTop: 0}, 1000);
                }
            } else {
                swal(correct_link);
                $('#url').prop('disabled', false);
            ...
            setTimeout(function () {
                $.ajax({
                    ...
                    success: function (resp) {
                        ...
                        $('.col-lg-4').find('#fileshare' + i).parents('.topichat_media_post').attr('data-chat_id', resp);
        ...
        if (key != 'item' && key != 'length')
        {
            ...
            if (/^image/.test(files[key].type)) { // only image file
                ...
                reader.onloadend = function () { // set image data as background of div
                   $('.total_views_inner').prepend('<div class="topichat_media_post chat_area_updated_list" data-chat_id=""> <div class="chat_area_updated_list_top"> <h4>Total <span class="watching_count">0</span> is Watching</h4><div class="total_views_list"><ul></ul></div><div class="clearfix"></div> </div> <div class="chat_area_updated_list_middle"> <div class="chat_area_updated_list_middle_left"> <div class="topichat_media_thumb"> <a href="javascript:void(0);"> <img class="user_chat_thumb" src="' + DEFAULT_PROFILE_IMAGE_PATH + "/" + data.user_image + '" title="' + data.name + '"/> </a> </div> <div id="field" class="topichat_media_rank"> <button type="button" id="add" class="add add_btn smlr_btn"> <img src="' + DEFAULT_IMAGE_PATH + 'challeng_arrow.png" class="rank_img_sec"/> </button> <span class="rank_rate">0</span> <button type="button" id="sub" class="sub smlr_btn"> <img src="' + DEFAULT_IMAGE_PATH + 'challeng_arrow.png" class="rank_img_sec"/> </button> </div> </div> <div class="chat_area_updated_list_middle_right"> <div class="chat_area_updated_list_middle_head"> <h4>'+image_title+'</h4> </div> <div class="chat_area_updated_list_middle_middle"> <div class="wdth_span media_wrapper img_media_wrapper"> <span class="imagePreview' + i + '" id="imagePreview_msg" data-toggle="modal" data-target="#postModal" data-image="" data-type="image"> </span> </div> </div> </div> </div> </div>');
                    ...
                    $.ajax({
                        ...
                        success: function (str)
                        {
                            if (str != 0)
                            {
                                ...
                                var html = '<li class="topi_image_li topichat_media_post" data-chat_id=""> <a data-toggle="modal" data-target="#postModal" data-image="' + media_file[0].media + '" data-type="image" class="imagePreview' + i +'"> <img src="' + upload_path + media_file[0].media + '" class="img-responsive topi_image"> </a> </li>';
    ...
    $.ajax({
        ...
        success: function (str)
        {
            ...
            else if (str != 0)
            {
                ...
                $('.total_views_inner').prepend('<div class="topichat_media_post chat_area_updated_list" data-chat_id=""> <div class="chat_area_updated_list_top"> <h4>Total <span class="watching_count">0</span> is Watching</h4><div class="total_views_list"><ul></ul></div> <div class="clearfix"></div> </div> <div class="chat_area_updated_list_middle"> <div class="chat_area_updated_list_middle_left"> <div class="topichat_media_thumb"> <a href="javascript:void(0);"> <img class="user_chat_thumb" src="' + DEFAULT_PROFILE_IMAGE_PATH + "/" + data.user_image + '" title="' + data.name + '"> </a> </div> <div id="field" class="topichat_media_rank"> <button type="button" id="add" class="add add_btn smlr_btn"> <img src="' + DEFAULT_IMAGE_PATH + 'challeng_arrow.png" class="rank_img_sec"/> </button> <span class="rank_rate">0</span> <button type="button" id="sub" class="sub smlr_btn"> <img src="' + DEFAULT_IMAGE_PATH + 'challeng_arrow.png" class="rank_img_sec"/> </button> </div> </div> <div class="chat_area_updated_list_middle_right"> <div class="chat_area_updated_list_middle_head"> <h4>'+video_title+'</h4> </div> <div class="chat_area_updated_list_middle_middle"> <div class="wdth_span media_wrapper img_media_wrapper"> <span class="' + display_file_class + ' video-w-icon" id="imagePreview_msg" data-toggle="modal" data-target="#postModal" data-image="'+media_file[0].media+'" data-type="video"> </span> </div> </div> </div> </div> </div>');
    ...
    Server.bind('message', function (payload) {
        ...
        else
        {
            if (userdata.media_type == "image")
            {
                ...
                var html = '<li class="topi_image_li topichat_media_post" data-chat_id="'+userdata.chat_id+'"> <a data-toggle="modal" data-target="#postModal" data-image="' + userdata.media + '" data-type="image"> <img src="' + upload_path + userdata.media + '" class="img-responsive topi_image"> </a> </li>';
                $('.topichat_image_ul').prepend(html);
            ...
            else if (userdata.media_type == "video")
            {
                ...
                $('.total_views_inner').prepend('<div class="topichat_media_post chat_area_updated_list" data-chat_id="'+userdata.chat_id+'"> <div class="chat_area_updated_list_top"> <h4>Total <span class="watching_count">0</span> is Watching</h4><div class="total_views_list"><ul></ul></div> <div class="clearfix"></div> </div> <div class="chat_area_updated_list_middle"> <div class="chat_area_updated_list_middle_left"> <div class="topichat_media_thumb"> <a href="javascript:void(0);"> <img class="user_chat_thumb" src="' + DEFAULT_PROFILE_IMAGE_PATH + "/" + userdata.user_image + '" title="' + userdata.user + '"> </a> </div> <div id="field" class="topichat_media_rank"> <button type="button" id="add" class="add add_btn smlr_btn"> <img src="' + DEFAULT_IMAGE_PATH + 'challeng_arrow.png" class="rank_img_sec"/> </button> <span class="rank_rate">0</span> <button type="button" id="sub" class="sub smlr_btn"> <img src="' + DEFAULT_IMAGE_PATH + 'challeng_arrow.png" class="rank_img_sec"/> </button> </div> </div> <div class="chat_area_updated_list_middle_right"> <div class="chat_area_updated_list_middle_head"> <h4>'+userdata.title+'</h4> </div> <div class="chat_area_updated_list_middle_middle"> <div class="wdth_span media_wrapper img_media_wrapper"> <span class="imagePreview' + i+ ' video-w-icon" id="imagePreview_msg" data-toggle="modal" data-target="#postModal" data-image="'+ userdata.media +'" data-type="video"> </span> </div> </div> </div> </div> </div>');
                ...
                var html = '<li class="topi_image_li topichat_media_post" data-chat_id="'+userdata.chat_id+'"> <a data-toggle="modal" data-target="#postModal" class="video-w-icon" data-image="' + userdata.media + '" data-type="video" > <img src="' + upload_path + video_thumb + '" class="img-responsive topi_image"> </a> </li>';
                $('.topichat_video_ul').prepend(html);
            }
            else if (userdata.media_type == "files")
            {
                ...
                if (userdata.youtube_video != null) {
                    ...
                    $('.total_views_inner').prepend('<div class="topichat_media_post chat_area_updated_list" data-chat_id="' + userdata.chat_id + '"> <div class="chat_area_updated_list_top"> <h4>Total <span class="watching_count">0</span> is Watching</h4><div class="total_views_list"><ul></ul></div> <div class="clearfix"></div> </div> <div class="chat_area_updated_list_middle"> <div class="chat_area_updated_list_middle_left"> <div class="topichat_media_thumb"> <a href="javascript:void(0);"> <img class="user_chat_thumb" src="'+DEFAULT_PROFILE_IMAGE_PATH+userdata.user_image+'" title="'+userdata.user+'"> </a> </div> <div id="field" class="topichat_media_rank"> <button type="button" id="add" class="add add_btn smlr_btn"> <img src="'+DEFAULT_IMAGE_PATH+'challeng_arrow.png" class="rank_img_sec"/> </button> <span class="rank_rate">0</span> <button type="button" id="sub" class="sub smlr_btn"> <img src="'+DEFAULT_IMAGE_PATH+'challeng_arrow.png" class="rank_img_sec"/> </button> </div> </div> <div class="chat_area_updated_list_middle_right"> <div class="chat_area_updated_list_middle_head"> <h4>'+userdata.title+'</h4> </div> <div class="chat_area_updated_list_middle_middle"> <div class="fileshare" data-toggle="modal" data-target="#postModal"> <div class="">'+ thumbnail_url +' <div class="large-9 column"> <a href="' + userlink.url + '" target="_blank">'+title +'</a> <p> '+ description + '</p> </div> </div> </div> </div> </div> </div> </div>');
